...
export default async function Europe() {
  ...
  const eur = await getCountries()
  const europe = eur.filter(country => country.region === 'Europe')
  ...
  return (
    <div>
      <h1 className="uppercase text-center font-bold text-sky-400 py-5">European Countries</h1>
